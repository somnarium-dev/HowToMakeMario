...
function loadCharacterSprites(_character_code_name, _player_power_name)
{
	...
	return_data[player_state.map]			= asset_get_index("spr_" + _character_code_name + "_" +  _player_power_name + "_map");
	return_data[player_state.pin]			= asset_get_index("spr_" + _character_code_name + "_pin");
